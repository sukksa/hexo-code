...
### 使用[json-server](https://github.com/typicode/json-server) 搭建REST API

#### json-server 

json-server 是用来快速搭建REST API 的工具包
...
5. 使用浏览器访问测试 `http://localhost:3000/posts`

##  XHR 的 ajax封装 (简单版axios)
